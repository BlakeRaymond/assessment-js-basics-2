...
let empOne = new Employee("Jane", "Weekday Nights")
console.log(empOne)
...
const manager = new Manager("Winston", "Weekday Nights", "Cece")
console.log(manager)

const schmidt = {...empTwo, name: "Schmidt"}
console.log(schmidt)
